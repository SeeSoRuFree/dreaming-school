    ...
    <>
      ...
      <section className="bg-white">
        <div className="container-main section-padding">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-orange-600 font-medium">배움의 행복을 전하고 삶의 가치를 나누는 사회적협동조합</p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-8 md:p-12 shadow-lg">
                <p className="text-xl font-semibold text-orange-600 text-center mb-8">
                  자기 손으로 직접 집을 짓는 경험보다 더 큰 감동이 있을까요?
                </p>
                <div className="space-y-4 mb-8">
                  <p className="body-text leading-relaxed">
                    집짓기에는 <span className="font-semibold text-orange-600">서로 협력하고 도와주어야 이룰 수 있는 집단성취감</span>이 담겨 있습니다.
                  </p>
                  <p className="body-text leading-relaxed">
                    집짓기에는 <span className="font-semibold text-orange-600">생각의 범위를 확장시키는 과학과 수학의 원리</span>가 담겨 있습니다.
                  </p>
                  <p className="body-text leading-relaxed">
                    집짓기에는 <span className="font-semibold text-orange-600">각종 장비와 도구는 물론 톱질, 망치질의 굵은 땀방울</span>이 담겨 있습니다.
                  </p>
                  <p className="body-text leading-relaxed">
                    집짓기에는 <span className="font-semibold text-orange-600">인내와 책임감을 통한 인격적 성장</span>이 담겨 있습니다.
                  </p>
                </div>
                <div className="bg-white/70 p-6 rounded-xl border-2 border-orange-200">
            ...
            <div className="mb-16">
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-pink-50 rounded-2xl p-8 md:p-12 shadow-lg">
                <div className="space-y-4">
                  <p className="body-text leading-relaxed">
                    청소년들의 바른 성장을 방해하는 가장 큰 요인 중 하나가 <span className="font-semibold text-pink-600">중독과 무기력증</span>입니다.
                  </p>
                  <p className="body-text leading-relaxed">
                    정적 프로그램의 비중이 높은 교육현실 속에서 청소년들의 <span className="font-semibold text-pink-600">역동적 에너지 발산 기회가 부족</span>합니다.
                  </p>
                  <p className="body-text leading-relaxed">
                    많은 청소년들 가운데 하고 싶은 것도 되고 싶은 것도 없는 <span className="font-semibold text-pink-600">심각한 무기력증</span>을 발견하게 됩니다.
                  </p>
                  <p className="body-text leading-relaxed">
                    집짓기 프로그램은 톱질, 망치질 등 역동적 활동이 중심이어서 청소년들의 <span className="font-semibold text-pink-600">역동성과 열정을 이끌어</span> 냅니다.
                  </p>
                  <p className="body-text leading-relaxed bg-white/70 p-4 rounded-lg border-2 border-yellow-200">
            ...
            <div className="mb-16">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-2xl p-8 md:p-12 shadow-lg">
                <p className="body-text leading-relaxed mb-6">
                  꿈을짓는학교는 단순히 집을 짓는 과정이 아닌 <span className="font-semibold text-orange-600">꿈을 짓는 과정</span>을 전달합니다.
                </p>
                <p className="body-text leading-relaxed mb-6">
                  집짓기에 참여한 모든 청소년들은 <span className="font-semibold text-orange-600">'Dream builders'</span>라는 정체성을 가지고
                  집과 함께 자신만의 꿈을 발견하고 세워 나가는 과정을 배우게 됩니다.
                </p>
                <p className="body-text leading-relaxed mb-6">
                  물론 그 과정 속에서 집을 구성하는데 필요한 <span className="font-semibold text-orange-600">수학과 과학적 원리, 집의 구조에 대한 지식,
                  각종 도구와 공구를 다루는 원리와 방법</span> 등을 함께 익혀 전인적인 성장을 도모하게 됩니다.
                </p>
                <p className="body-text leading-relaxed bg-white/70 p-4 rounded-lg border-2 border-pink-200">
                  그 모든 과정 속에서 마침내 해낸 <span className="font-semibold text-pink-600">긍지와 자부심</span>,
                  한 사람 한 사람의 <span className="font-semibold text-pink-600">존엄성의 중요성</span>을 배우게 됩니다.
                </p>
              </div>
            </div>
            ...
            <div className="mb-16">
              ...
              <div className="bg-gradient-to-br from-orange-50 via-yellow-50 to-pink-50 rounded-2xl p-8 md:p-12 shadow-lg">
                <p className="body-text leading-relaxed mb-6">
                  '세상에서 가장 위대한 한 평 집짓기' 프로그램은 <span className="font-semibold text-orange-600">품성교육+이론교육+실기교육이 복합된
                  키자니아식 교육방식</span>입니다.
                </p>
                <p className="body-text leading-relaxed mb-6">
                  참여자는 각종 도구를 장착한 실제 건축가의 복장으로 참여하여 <span className="font-semibold text-orange-600">모든 과정을 스스로 해 나가게</span> 됩니다.
                </p>
                <p className="body-text leading-relaxed mb-6">
                  그 과정에서 우리는 잘 하는 아이를 칭찬하기 보다 <span className="font-semibold text-orange-600">부족한 아이를 격려하고 북돋아
                  새로운 용기와 자기효능감을 높이고자</span> 합니다.
                </p>
                <p className="body-text leading-relaxed bg-white/70 p-4 rounded-lg border-2 border-yellow-300">
                  우리 교육방식의 차별점은 품성교육을 통한 <span className="font-semibold text-pink-600">올바른 인성과 사고력의 성장</span>에 초점을 맞춰
                  단순한 체험의 확대가 아닌 <span className="font-semibold text-pink-600">심신의 성장, 인격적 성장</span>을 도모하는 것입니다.
                </p>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-b from-white to-orange-50">
        <div className="container-main section-padding">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">핵심 가치</h2>
              <p className="text-xl text-orange-600 font-medium">꿈을짓는학교가 추구하는 교육 가치</p>
            </div>

            {/* Key Features Grid */}
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-orange-400 hover:shadow-md transition-shadow">
                <h3 className="text-xl font-bold text-gray-800 mb-2">키자니아식 교육</h3>
                <p className="text-gray-600">품성교육 + 이론 + 실기가 복합된 현장감 있는 체험교육</p>
              </div>

              <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-yellow-400 hover:shadow-md transition-shadow">
                <h3 className="text-xl font-bold text-gray-800 mb-2">전문 조합원 운영</h3>
                <p className="text-gray-600">다양한 분야의 전문가 11명이 함께하는 교육 공동체</p>
              </div>

              <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-pink-400 hover:shadow-md transition-shadow">
      ...
      <section className="bg-white py-16">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">활동 갤러리</h2>
          <p className="text-xl text-orange-600 font-medium">꿈을짓는학교의 다양한 활동 모습</p>
        </div>
      ...
      <section className="bg-gradient-to-b from-yellow-50 to-white">
        <div className="container-main section-padding">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">우리가 만들어가는 교육 현장</h2>
              <p className="text-xl text-orange-600 font-medium">학교와 지역사회가 함께하는 체험교육의 현장</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-lg p-6 mb-6 border-2 border-orange-200">
                  <h4 className="text-lg font-semibold text-orange-700 mb-3">품성·이론·실기 복합교육</h4>
                  <p className="text-gray-700 leading-relaxed">
                    꿈을짓는학교는 <span className="font-semibold text-orange-600">품성교육 + 이론 + 실기</span>가
        ...
        <div className="container-main section-padding">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              <div className="bg-gradient-to-r from-orange-500 to-pink-500 rounded-2xl overflow-hidden shadow-2xl">
                <div className="grid md:grid-cols-2 gap-0">
                  <div className="p-8 md:p-12 text-white">
                    ...
                    <ul className="space-y-3 mb-8">
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-yellow-200 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-white">실기, 이론, 품성교육의 복합교육</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-yellow-200 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-white">키자니아식 현장감있는 교육</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-yellow-200 mr-3 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <span className="text-white">10~12회기 (회당 2~3시간)</span>
                      </li>
                    </ul>
                    <Link href="/programs" className="inline-flex items-center bg-white text-orange-600 font-semibold px-6 py-3 rounded-lg hover:bg-orange-50 transition-colors">
                      자세히 보기
                  ...
                  <div className="relative bg-gradient-to-br from-orange-500/20 to-pink-500/20 h-full min-h-[300px] overflow-hidden">
                    <Image
                    ...
                    />
                    {/* 이미지 위 그라데이션 오버레이 */}
                    <div className="absolute inset-0 bg-gradient-to-t from-orange-600/60 via-pink-500/20 to-transparent"></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-8 border-l-4 border-orange-400">
              <div className="">
                <div className="">
                  ...
                  <p className="text-sm text-orange-600 font-semibold">단기 및 심화과정 운영</p>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-8 border-l-4 border-yellow-400">
              <div className="">
                <div className="">
                  ...
                  <p className="text-sm text-yellow-600 font-semibold">학생 참여형 공간 설계</p>
                </div>
              </div>
            </div>

            <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-8 border-l-4 border-pink-400">
              <div className="">
                <div className="">
                  ...
                  <p className="text-sm text-pink-600 font-semibold">10차수 체계적 교육</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition-all p-8 border-l-4 border-orange-400">
              <div className="">
                <div className="">
                  ...
                  <p className="text-sm text-orange-600 font-semibold">지역 맞춤형 교육</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mt-12">
            <Link href="/programs" className="inline-flex items-center bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-semibold px-8 py-4 rounded-lg transition-all shadow-lg hover:shadow-xl">
              전체 프로그램 상세보기
      ...
      <section className="bg-white py-16">
        ...
        <div className="text-center px-4">
          <p className="text-lg text-gray-700 leading-relaxed max-w-3xl mx-auto">
            매 순간이 소중한 배움이 되는 <span className="text-orange-600 font-semibold">꿈을짓는학교</span>에서<br/>
            아이들은 자신의 가능성을 발견하고 <span className="text-pink-600 font-semibold">미래를 준비</span>합니다.
          </p>
        </div>
      </section>

      {/* CTA Section */}
      <section className="bg-gradient-to-br from-orange-50 via-yellow-50 to-pink-50">
        <div className="container-main section-padding text-center">
          ...
          <Link href="/contact" className="bg-gradient-to-r from-orange-500 to-pink-500 hover:from-orange-600 hover:to-pink-600 text-white font-medium px-8 py-3 rounded-full transition-all duration-200 shadow-md hover:shadow-lg inline-block">
            문의하기
          </Link>
        </div>
      </section>
